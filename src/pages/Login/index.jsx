    ...
    <div>
      ...
      <div className="max-w-md mx-auto">
        <form onSubmit={onSubmit}>
          <div className="bg-white grid grid-cols-12 gap-x-6 gap-y-2">
            ...
            <div className="col-span-12 mt-2 flex items-center justify-center gap-x-2">
              <FormButton type="submit" status="normal" disabled={false} onClickEvent={() => {}} text="登入" />
            </div>
          </div>
        </form>
        ...
        <div className="mt-6 bg-white grid grid-cols-12 gap-x-6 gap-y-2">
          ...
          <div className="col-span-12 mt-2 flex items-center justify-center gap-x-2">
            <FormButton type="button" status="other" disabled={false} onClickEvent={onGoogleSignIn} text="以 Google 帳號登入" />
          </div>

          <div className="col-span-12 mt-2 flex items-center justify-center gap-x-2">
            <FormButton type="button" status="other" disabled={false} onClickEvent={onFacebookSignIn} text="以 Facebook 帳號登入" />
          </div>
        </div>
      </div>
      <ToastContainer />
